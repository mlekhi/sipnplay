        ...
        <div className="flex flex-row">
          <div className="text-start my-auto">
            <p className="text-xs sm:text-base">
              Come on in with your friends and family. Pick from a collection
            </p>
            <span className="bold-words text-sm sm:text-base">
              of over 500+ games for just $10/person!
            </span>
            <p className="text-xs sm:text-base mb-2">($12/person Friday-Sunday and Holidays)</p>
            <p className="text-xs sm:text-base">Enjoy 3 hours of gameplay while savouring</p>
            <span className="bold-words text-sm sm:text-base">
              bubble tea, coffee, beer, sandwiches and salads!
            </span>
            <p className="text-xs sm:text-base">If you want to guarantee a table,</p>
            <span className="bold-words text-sm sm:text-base">reserve for $15 per person!</span>
          </div>
